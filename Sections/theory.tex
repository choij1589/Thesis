...
\subsection{The Matter Content of the Standard Model}

The matter content of the SM is not an arbitrary collection of particles, but rather a structure organized by gauge symmetries. Each fermion's interactions are determined by how it transforms under the gauge group $\SU(3)_C \times \SU(2)_L \times \U(1)_Y$. Representation theory provides the organizing principle: fermions that fill $\SU(2)_L$ doublets interact differently from those in singlet representations. This symmetry-first perspective reveals why the observed three-generation pattern has theoretical coherence---each generation replicates the same representation structure under the gauge group, differing only in the Yukawa couplings that determine masses.
...
This generational structure was not predicted by theory but emerged from experimental discoveries. The first generation of quarks and leptons, identified in the early development of quantum field theory, formed the foundation for early models of weak interactions. The unexpected discovery of the muon (1936) and strange quark physics in the late 1940s revealed a second generation, prompting the Glashow-Iliopoulos-Maiani (GIM) mechanism and the prediction of the charm quark. The formulation of the electroweak theory by Glashow, Weinberg, and Salam in the 1960s~\cite{Glashow:1961tr,Weinberg:1967tq,Salam:1968rm} unified electromagnetic and weak forces acting on these fermions, incorporating them into the $\SU(2)_L \times \U(1)_Y$ gauge structure. The subsequent discovery of the third generation---the tau lepton (1975), bottom quark (1977), and finally the top quark (1995)---confirmed the pattern, establishing the three-generation framework as a cornerstone of the Standard Model. The fermion content with their electric charges and approximate masses are summarized in Table~\ref{tab:sm_fermions}:
...
Fermions are described by both left-handed and right-handed chirality states, which transform differently under the SM gauge group. This difference in transformation properties is not an arbitrary choice---it directly implements the experimentally observed maximal parity violation in weak interactions. The weak interaction couples only to left-handed fermions (and right-handed antifermions), a fact discovered through Wu's experiment on cobalt-60 beta decay in 1956. This experimental observation requires that left-handed and right-handed fermions transform differently under the electroweak gauge group: left-handed fermions form $\SU(2)_L$ doublets and thus ``feel'' weak isospin, while right-handed fermions are $\SU(2)_L$ singlets and do not. The mathematical structure of doublets versus singlets thus implements the physical fact of parity violation. In the minimal SM, only left-handed neutrinos (and right-handed antineutrinos) are observed experimentally; right-handed neutrinos are not included in the particle content.
...
\subsubsection{Fermion Representations and Chirality}

A defining feature of the electroweak theory is its chiral structure: left-handed and right-handed fermions transform differently under the $\SU(2)_L \times \U(1)_Y$ gauge group. This asymmetry connects directly to the parity violation observed in weak interactions, as noted in Section~\ref{sec:theory_sm}.

Left-handed fermions are organized into $\SU(2)_L$ doublets:
\begin{equation}
\ell_L = \begin{pmatrix} \nu_e \\ e^- \end{pmatrix}_L, \quad
q_L = \begin{pmatrix} u \\ d \end{pmatrix}_L
\end{equation}
while right-handed fermions are $\SU(2)_L$ singlets: $e_R$, $u_R$, $d_R$ (and similarly for the other generations). In the minimal SM, right-handed neutrinos $\nu_R$ are not included. This chiral structure is central to understanding electroweak interactions. The $\SU(2)_L$ generators act non-trivially only on left-handed doublets, causing the weak charged currents to couple exclusively to left-handed fermions (and right-handed antifermions).
