...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    step/.style={draw, rounded corners=2pt, minimum height=0.7cm,
                 minimum width=1.55cm, align=center, font=\scriptsize},
    r2/.style={step, fill=orange!15},
    r3/.style={step, fill=green!12},
    lbl/.style={font=\scriptsize\itshape, text=black!70},
    rlbl/.style={font=\scriptsize\bfseries, text=black!80},
    arr/.style={-{Stealth[length=5pt]}, thick},
    sarr/.style={-{Stealth[length=4pt]}, semithick},
    ...
    % Run 2 chain
    \node[rlbl, below=1.1cm of pdf.south west, anchor=west] (r2lbl) {Run\,2:};
    ...
    % Run 3 chain
    \node[rlbl, below=0.55cm of r2lbl] (r3lbl) {Run\,3:};
    \node[r3, right=0.2cm of r3lbl] (r3a) {wmLHE\\[-1pt]GS};
    \node[r3, right=0.25cm of r3a]  (r3b) {DG\\[-1pt]Premix};
    \node[r3, right=0.25cm of r3b]  (r3c) {RECO};
    \node[r3, right=0.25cm of r3c]  (r3d) {Mini\\[-1pt]AOD};
    \node[r3, right=0.25cm of r3d]  (r3e) {Nano\\[-1pt]AOD};
